    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 mb-3">
            <div class="card">
              <div>
                <a href="/blog?category={{ $post->category->slug }}" class="text-decoration-none position-absolute px-3 py-2 text-white" style="background-color: rgba(0, 0, 0, 0.7)">{{ $post->category->name }}</a>
              </div>
